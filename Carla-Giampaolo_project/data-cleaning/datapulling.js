/* 
Retrieve required indicator data from Open Cage API and save it to a file.
...
const api_helper = require("api-helper.js")          // for making api calls easier to work with
...
function pull_data(output_filename) {
  ...
  function CallPagedApi(pageNo) {
    ...
    url = new URL("https://api.opencagedata.com/geocode/v1/json?key=16385e5cc80c4852a425bdd06bbb6012&q=52.3877830%2C+9.7334394&pretty=1&no_annotations=1")
